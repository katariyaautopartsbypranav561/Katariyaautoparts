    ...
    <div className="max-w-3xl animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-black text-gray-800 tracking-tight mb-2 flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-red-100 text-[#dc2626]">
                <Music size={22} />
              </span>
              Background Audio
            </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#dc2626] hover:bg-[#b91c1c] disabled:opacity-60 text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
          >
            {status === 'saving' ? (
              <>
      ...
      {hasUnsavedChanges && (
        <ScrollReveal delay={50}>
          <div className="mb-4 flex items-center gap-2 text-sm font-semibold text-red-700 bg-red-50 border border-red-200 rounded-xl px-4 py-2.5 w-fit">
      ...
      <div className="space-y-6">
        ...
        <ScrollReveal delay={100}>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-2xl border border-gray-700">
            ...
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-red-400/10 rounded-full blur-2xl pointer-events-none" />

            <div className="relative p-6">
              {/* Header row */}
              <div className="flex items-center gap-3 mb-5">
                <div className="flex items-center justify-center w-10 h-10 rounded-2xl bg-red-500/20 text-red-400 ring-1 ring-red-500/30">
                  <Volume2 size={20} />
                </div>
                <div>
              ...
              <div className="flex items-end gap-1 mb-5 h-8">
                {[3, 6, 4, 8, 5, 7, 3, 6, 5, 4, 7, 5, 3, 6].map((h, i) => (
                  <div
                    key={i}
                    className="w-1.5 rounded-full bg-red-500/60"
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#dc2626] focus:ring-2 focus:ring-red-100 transition-all font-medium text-sm"
                  />
                  <button
                    onClick={handleUrlApply}
                    className="shrink-0 px-4 py-3 bg-red-50 hover:bg-red-100 text-[#dc2626] font-bold rounded-xl border border-red-200 transition-all text-sm"
                  >
                    Preview
                  </button>
                </div>
            ...
            {inputMode === 'file' && (
              <div className="space-y-3">
                ...
                <div
                  className="relative flex flex-col items-center justify-center gap-3 w-full border-2 border-dashed border-red-200 rounded-2xl p-8 bg-red-50/40 hover:bg-red-50 cursor-pointer transition-all group"
                  onClick={() => fileInputRef.current?.click()}
                >
                  <div className="w-14 h-14 rounded-2xl bg-red-100 group-hover:bg-red-200 flex items-center justify-center text-[#dc2626] transition-all">
                    <Upload size={26} />
                  </div>
                  {fileName ? (
        ...
        <ScrollReveal delay={200}>
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              ...
              <code className="bg-gray-100 px-1.5 py-0.5 rounded-md text-xs font-mono text-red-700">
                /background.mp3
              </code>
              .
            </p>
