      ...
      <form onSubmit={handleSubmit} className="bg-white border border-gray-100 shadow-sm rounded-3xl p-8">
        ...
        <div className="space-y-6">
          ...
          {targetType === 'SPECIFIC' && (
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-800 focus:outline-none focus:border-[#ef4444] focus:ring-1 focus:ring-[#ef4444] transition-all"
          ...
          <div>
            ...
            <input
              ...
              placeholder="Huge Festive Sale! 50% Off Dry Fruits 🎉"
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-800 focus:outline-none focus:border-[#ef4444] focus:ring-1 focus:ring-[#ef4444] transition-all font-semibold"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-800 focus:outline-none focus:border-[#ef4444] focus:ring-1 focus:ring-[#ef4444] transition-all resize-y"
              required
            />
            <div className="mt-2 flex items-start gap-2 bg-[#ef4444]/10 border border-[#ef4444]/20 rounded-lg p-3">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <label 
                htmlFor="file-upload" 
                className="flex items-center justify-center gap-2 w-full border-2 border-dashed border-gray-300 hover:border-[#ef4444] rounded-xl px-4 py-8 cursor-pointer transition-colors group bg-gray-50"
              >
                {attachment ? (
                  <div className="text-center">
                    <p className="text-gray-800 font-bold group-hover:text-[#ef4444] transition-colors">{attachment.name}</p>
                    <p className="text-xs text-gray-500 mt-1 font-medium">{(attachment.size / 1024 / 1024).toFixed(2)} MB</p>
                  </div>
                ) : (
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center group-hover:bg-[#ef4444]/20 group-hover:text-[#ef4444] transition-colors text-gray-500">
                      <FileUp size={20} />
                    </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
          <button
            type="submit"
            disabled={sending}
            className="flex items-center gap-2 bg-[#ef4444] text-white font-bold py-3 px-8 rounded-xl hover:bg-red-600 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#ef4444] shadow-sm"
          >
            {sending ? (
              <>
