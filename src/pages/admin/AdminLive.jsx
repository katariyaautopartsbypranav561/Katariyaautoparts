      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ScrollReveal key={log.id}>
                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                  <div className="flex flex-col sm:flex-row gap-5 relative z-10">
                    ...
                    {/* Icon */}
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm ${log.type === 'visit' ? 'bg-red-50 border border-red-100 text-red-500' : 'bg-red-50 border border-red-100 text-[#dc2626]'}`}>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          ...
                          {log.visitor.fcmToken && (
                            <button 
                              ...
                              className="ml-auto flex items-center gap-1.5 bg-red-50 text-red-600 hover:bg-red-100 text-xs px-3 py-1.5 rounded-lg border border-red-200 font-bold transition-colors"
                            >
                              <Send size={14} />
                              Send Push
                            </button>
        ...
        <div className="lg:col-span-1 space-y-6">
          <ScrollReveal delay={100}>
            <div className="bg-gradient-to-br from-indigo-900 to-red-900 rounded-3xl p-6 shadow-lg text-white relative overflow-hidden">
