...
export default function AdminCustomers() {
  ...
  const stats = [
    { label: 'Total Users/Leads', value: usersDb?.length || 0, icon: Users, color: 'text-red-500', bg: 'bg-red-50' },
          ...
          <div className="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#dc2626] focus:ring-1 focus:ring-[#dc2626] transition-all w-64 md:w-80 text-sm"
              />
            </div>
          </div>
                    ...
                    <tr key={user.id} className="hover:bg-red-50/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${
                          user.role === 'admin' ? 'bg-purple-100 text-purple-700' : (user.role === 'lead' ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700')
                        }`}>
