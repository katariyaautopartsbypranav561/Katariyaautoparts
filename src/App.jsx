...
function AppInner() {
  ...
  return (
    <div className="min-h-screen mesh-bg text-gray-800 font-sans relative">
      <PageLoader 
        skip={false}
        dataReady={!loading}
        onFinish={() => {
      ...
      <button
        ...
        className="md:bottom-6 fixed bottom-[100px] left-4 z-[75] group bg-[#171717]/90 hover:bg-[#dc2626] text-red-100 p-2.5 rounded-full backdrop-blur shadow-lg transition-all duration-200 border border-[#dc2626]/30 hover:scale-110 hover:shadow-[0_0_20px_rgba(208,126,32,0.5)]"
